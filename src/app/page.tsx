...
export default function Home() {
  ...
  // Tab states for language translations in modals
  const [editModalLangTab, setEditModalLangTab] = useState("en");
  const [catModalLangTab, setCatModalLangTab] = useState("en");
      ...
      if (res.ok && data.success) {
        if (isEdit && editingCategory) {
          setEditingCategory({
            ...
            seo_description: data.description,
            seo_keywords: data.keywords,
            seo_title_fr: data.title_fr || editingCategory.seo_title_fr || "",
            seo_description_fr: data.description_fr || editingCategory.seo_description_fr || "",
            seo_keywords_fr: data.keywords_fr || editingCategory.seo_keywords_fr || "",
            seo_title_es: data.title_es || editingCategory.seo_title_es || "",
            seo_description_es: data.description_es || editingCategory.seo_description_es || "",
            seo_keywords_es: data.keywords_es || editingCategory.seo_keywords_es || ""
          });
        } else {
          setNewCategory({
            ...newCategory,
            ...
            seo_description: data.description,
            seo_keywords: data.keywords,
            seo_title_fr: data.title_fr || newCategory.seo_title_fr || "",
            seo_description_fr: data.description_fr || newCategory.seo_description_fr || "",
            seo_keywords_fr: data.keywords_fr || newCategory.seo_keywords_fr || "",
            seo_title_es: data.title_es || newCategory.seo_title_es || "",
            seo_description_es: data.description_es || newCategory.seo_description_es || "",
            seo_keywords_es: data.keywords_es || newCategory.seo_keywords_es || ""
          });
        }
        setMessage("Category SEO successfully generated by AI for all languages!");
      } else {
        setMessage(`AI Error: ${data.error}`);
      }
    } catch (e) {
      ...
      if (res.ok && data.success) {
        if (isEdit && editingCategory) {
          setEditingCategory({
            ...
            content_unit_fr: data.content_unit_fr || editingCategory.content_unit_fr || "",
            content_unit_es: data.content_unit_es || editingCategory.content_unit_es || ""
          });
        } else {
          setNewCategory({
            ...newCategory,
            content_unit: data.content_unit,
            content_unit_fr: data.content_unit_fr || newCategory.content_unit_fr || "",
            content_unit_es: data.content_unit_es || newCategory.content_unit_es || ""
          });
        }
        setMessage("Category Content Unit (CU) successfully generated by AI for all languages!");
      } else {
        setMessage(`AI Error: ${data.error}`);
      }
    } catch (e) {
  ...
  const filteredGames = games.filter((game: any) => {
    ...
    let matchesSeo = true;
    if (seoFilter === "optimized" || seoFilter === "optimized_en") {
      matchesSeo = isOptimizedEn;
    } else if (seoFilter === "basic" || seoFilter === "basic_en") {
      matchesSeo = !isOptimizedEn;
    } else if (seoFilter === "optimized_fr") {
      matchesSeo = isOptimizedFr;
    } else if (seoFilter === "basic_fr") {
      matchesSeo = !isOptimizedFr;
    } else if (seoFilter === "optimized_es") {
      matchesSeo = isOptimizedEs;
    } else if (seoFilter === "basic_es") {
      matchesSeo = !isOptimizedEs;
    }
                        ...
                        <td className="p-3">
                          <div className="flex flex-col gap-1 text-xs">
                            <span className="flex items-center gap-1">
                              ...
                              {cat.seo_description && cat.seo_description.length > 20 ? (
                            ...
                            <span className="flex items-center gap-1">
                              <span className="font-semibold w-6">FR:</span>
                              {cat.seo_description_fr && cat.seo_description_fr.length > 20 && cat.seo_description_fr !== cat.seo_description ? (
                                <span className="text-green-600 font-medium">✅ Optimized</span>
                              ) : (
                                <span className="text-yellow-600 font-medium">⚠️ Basic</span>
                              )}
                            ...
                            <span className="flex items-center gap-1">
                              <span className="font-semibold w-6">ES:</span>
                              {cat.seo_description_es && cat.seo_description_es.length > 20 && cat.seo_description_es !== cat.seo_description ? (
                                <span className="text-green-600 font-medium">✅ Optimized</span>
                              ) : (
                                <span className="text-yellow-600 font-medium">⚠️ Basic</span>
                              )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="optimized_en">EN Optimized Only</option>
                    <option value="basic_en">EN Basic Only</option>
                    <option value="optimized_fr">FR Optimized Only</option>
                    <option value="basic_fr">FR Basic Only</option>
                    <option value="optimized_es">ES Optimized Only</option>
                    <option value="basic_es">ES Basic Only</option>
                  </select>
                </div>
                <div>
                        ...
                        <tr key={game.id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="p-3">
                            <div className="flex flex-col gap-1 text-xs">
                              ...
                              <span className="flex items-center gap-1">
                                <span className="font-semibold w-6">FR:</span>
                                {game.description_fr && game.description_fr.length > 20 && game.description_fr !== game.description ? (
                                  <span className="text-green-600 font-medium">✅ Optimized</span>
                                ) : (
                                  <span className="text-yellow-600 font-medium">⚠️ Basic</span>
                                )}
                              ...
                              <span className="flex items-center gap-1">
                                <span className="font-semibold w-6">ES:</span>
                                {game.description_es && game.description_es.length > 20 && game.description_es !== game.description ? (
                                  <span className="text-green-600 font-medium">✅ Optimized</span>
                                ) : (
                                  <span className="text-yellow-600 font-medium">⚠️ Basic</span>
                                )}
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200 mt-4">
                <div className="flex justify-between items-center mb-2">
                  <label className="block text-sm font-bold text-gray-800">SEO Page Title ({catModalLangTab.toUpperCase()})</label>
                  <button
                ...
                {catModalLangTab === "fr" && (
                  <input
                    type="text"
                    value={newCategory.seo_title_fr || ""}
                    placeholder={newCategory.seo_title}
                    onChange={e => setNewCategory({ ...newCategory, seo_title_fr: e.target.value })}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
                {catModalLangTab === "es" && (
                  <input
                    type="text"
                    value={newCategory.seo_title_es || ""}
                    placeholder={newCategory.seo_title}
                    onChange={e => setNewCategory({ ...newCategory, seo_title_es: e.target.value })}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
              </div>
              ...
              <div>
                <label className="block text-sm font-bold text-gray-800">SEO Description ({catModalLangTab.toUpperCase()})</label>
                {catModalLangTab === "en" && (
                  <textarea
                ...
                {catModalLangTab === "fr" && (
                  <textarea
                    value={newCategory.seo_description_fr || ""}
                    placeholder={newCategory.seo_description}
                    onChange={e => setNewCategory({ ...newCategory, seo_description_fr: e.target.value })}
                    rows={3}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
                {catModalLangTab === "es" && (
                  <textarea
                    value={newCategory.seo_description_es || ""}
                    placeholder={newCategory.seo_description}
                    onChange={e => setNewCategory({ ...newCategory, seo_description_es: e.target.value })}
                    rows={3}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
              ...
              <div>
                <label className="block text-sm font-bold text-gray-800">SEO Keywords ({catModalLangTab.toUpperCase()})</label>
                {catModalLangTab === "en" && (
                  <input
                    type="text"
                ...
                {catModalLangTab === "fr" && (
                  <input
                    type="text"
                    value={newCategory.seo_keywords_fr || ""}
                    placeholder={newCategory.seo_keywords}
                    onChange={e => setNewCategory({ ...newCategory, seo_keywords_fr: e.target.value })}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
                {catModalLangTab === "es" && (
                  <input
                    type="text"
                    value={newCategory.seo_keywords_es || ""}
                    placeholder={newCategory.seo_keywords}
                    onChange={e => setNewCategory({ ...newCategory, seo_keywords_es: e.target.value })}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
              </div>
              ...
              <div className="pt-4 border-t border-gray-200 mt-4">
                <div className="flex justify-between items-center mb-2">
                  <label className="block text-sm font-bold text-gray-800">Copywriting Unit (CU) HTML ({catModalLangTab.toUpperCase()})</label>
                  <button
                ...
                {catModalLangTab === "fr" && (
                  <textarea
                    value={newCategory.content_unit_fr || ""}
                    placeholder={newCategory.content_unit}
                    onChange={e => setNewCategory({ ...newCategory, content_unit_fr: e.target.value })}
                    rows={6}
                    className="w-full border rounded p-2 text-sm font-mono text-gray-800"
                  />
                )}
                {catModalLangTab === "es" && (
                  <textarea
                    value={newCategory.content_unit_es || ""}
                    placeholder={newCategory.content_unit}
                    onChange={e => setNewCategory({ ...newCategory, content_unit_es: e.target.value })}
                    rows={6}
                    className="w-full border rounded p-2 text-sm font-mono text-gray-800"
                  />
                )}
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200 mt-4">
                ...
                {catModalLangTab === "fr" && (
                  <input
                    type="text"
                    value={editingCategory.seo_title_fr || ""}
                    placeholder={editingCategory.seo_title}
                    onChange={e => setEditingCategory({ ...editingCategory, seo_title_fr: e.target.value })}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
                {catModalLangTab === "es" && (
                  <input
                    type="text"
                    value={editingCategory.seo_title_es || ""}
                    placeholder={editingCategory.seo_title}
                    onChange={e => setEditingCategory({ ...editingCategory, seo_title_es: e.target.value })}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
              </div>
              ...
              <div>
                ...
                {catModalLangTab === "fr" && (
                  <textarea
                    value={editingCategory.seo_description_fr || ""}
                    placeholder={editingCategory.seo_description}
                    onChange={e => setEditingCategory({ ...editingCategory, seo_description_fr: e.target.value })}
                    rows={3}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
                {catModalLangTab === "es" && (
                  <textarea
                    value={editingCategory.seo_description_es || ""}
                    placeholder={editingCategory.seo_description}
                    onChange={e => setEditingCategory({ ...editingCategory, seo_description_es: e.target.value })}
                    rows={3}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
              ...
              <div>
                ...
                {catModalLangTab === "fr" && (
                  <input
                    type="text"
                    value={editingCategory.seo_keywords_fr || ""}
                    placeholder={editingCategory.seo_keywords}
                    onChange={e => setEditingCategory({ ...editingCategory, seo_keywords_fr: e.target.value })}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
                {catModalLangTab === "es" && (
                  <input
                    type="text"
                    value={editingCategory.seo_keywords_es || ""}
                    placeholder={editingCategory.seo_keywords}
                    onChange={e => setEditingCategory({ ...editingCategory, seo_keywords_es: e.target.value })}
                    className="w-full border rounded p-2 text-sm"
                  />
                )}
              </div>
              ...
              <div className="pt-4 border-t border-gray-200 mt-4">
                ...
                {catModalLangTab === "fr" && (
                  <textarea
                    value={editingCategory.content_unit_fr || ""}
                    placeholder={editingCategory.content_unit}
                    onChange={e => setEditingCategory({ ...editingCategory, content_unit_fr: e.target.value })}
                    rows={6}
                    className="w-full border rounded p-2 text-sm font-mono text-gray-800"
                  />
                )}
                {catModalLangTab === "es" && (
                  <textarea
                    value={editingCategory.content_unit_es || ""}
                    placeholder={editingCategory.content_unit}
                    onChange={e => setEditingCategory({ ...editingCategory, content_unit_es: e.target.value })}
                    rows={6}
                    className="w-full border rounded p-2 text-sm font-mono text-gray-800"
                  />
                )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex gap-2 border-b pb-2 mb-4">
                {["en", "fr", "es"].map((lang) => (
                  <button
                    key={lang}
                    type="button"
                    onClick={() => setEditModalLangTab(lang)}
                    className={`px-4 py-1.5 rounded text-xs font-bold transition ${
                      editModalLangTab === lang
                        ? "bg-purple-600 text-white shadow-sm"
                        : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                    }`}
                  >
              ...
              {editModalLangTab !== "en" && (
                <div>
                  <label className="block text-sm font-medium text-gray-700">Translated Title ({editModalLangTab.toUpperCase()})</label>
                  {editModalLangTab === "fr" && (
                    <input
                      type="text"
                      value={editingGame.title_fr || ""}
                      placeholder={editingGame.title}
                      onChange={e => setEditingGame({...editingGame, title_fr: e.target.value})}
                      className="w-full border rounded p-2 mt-1 text-sm"
                    />
                  )}
                  {editModalLangTab === "es" && (
                    <input
                      type="text"
                      value={editingGame.title_es || ""}
                      placeholder={editingGame.title}
                      onChange={e => setEditingGame({...editingGame, title_es: e.target.value})}
                      className="w-full border rounded p-2 mt-1 text-sm"
                    />
                  )}
                </div>
              ...
              <div className="pt-4 border-t border-gray-200 mt-4">
                <div className="flex justify-between items-center mb-2">
                  <label className="block text-sm font-bold text-gray-800">SEO Description ({editModalLangTab.toUpperCase()})</label>
                  <button 
                    onClick={optimizeSeo} 
                    disabled={optimizing}
                    className="bg-purple-100 hover:bg-purple-200 text-purple-700 border border-purple-300 text-xs font-bold py-1 px-3 rounded shadow-sm disabled:opacity-50"
                ...
                {editModalLangTab === "fr" && (
                  <textarea 
                    value={editingGame.description_fr || ""} 
                    placeholder={editingGame.description}
                    onChange={e => setEditingGame({...editingGame, description_fr: e.target.value})} 
                    className="w-full border rounded p-2 text-sm" 
                    rows={4} 
                  />
                )}
                {editModalLangTab === "es" && (
                  <textarea 
                    value={editingGame.description_es || ""} 
                    placeholder={editingGame.description}
                    onChange={e => setEditingGame({...editingGame, description_es: e.target.value})} 
                    className="w-full border rounded p-2 text-sm" 
                    rows={4} 
                  />
                )}
              ...
              <div>
                <label className="block text-sm font-bold text-gray-800">SEO Keywords ({editModalLangTab.toUpperCase()})</label>
                {editModalLangTab === "en" && (
                  <input 
                    type="text" 
                ...
                {editModalLangTab === "fr" && (
                  <input 
                    type="text" 
                    value={editingGame.seo_keywords_fr || ""} 
                    placeholder={editingGame.seo_keywords}
                    onChange={e => setEditingGame({...editingGame, seo_keywords_fr: e.target.value})} 
                    className="w-full border rounded p-2 mt-1 text-sm" 
                  />
                )}
                {editModalLangTab === "es" && (
                  <input 
                    type="text" 
                    value={editingGame.seo_keywords_es || ""} 
                    placeholder={editingGame.seo_keywords}
                    onChange={e => setEditingGame({...editingGame, seo_keywords_es: e.target.value})} 
                    className="w-full border rounded p-2 mt-1 text-sm" 
                  />
                )}
              </div>
